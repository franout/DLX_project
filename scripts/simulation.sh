...
vlog +incdir+/software/mentor/questa10.7c/questasim/uvm-"$UVM_VERSION"/../verilog_src/uvm-"$UVM_VERSION"/src -incr ${path_to_file}test_bench/uvm_class_def/dlx_sequence_item.sv
vlog +incdir+/software/mentor/questa10.7c/questasim/uvm-"$UVM_VERSION"/../verilog_src/uvm-"$UVM_VERSION"/src -incr ${path_to_file}test_bench/uvm_class_def/dlx_sequence.sv
...
vsim -c -sv_lib /software/mentor/questa10.7c/questasim/uvm-"$UVM_VERSION"/linux_x86_64/uvm_dpi +UVM_STACKTRACE  -suppress 8664  work.tb_dlx_uvm -do ./scripts/dlx_uvm_tb.do  
else
