...
#  Created on Sun Sep 13 02:24:26 2020                
#                                                     
#######################################################
...
dumpPictures -dir ./images_nopt/ -prefix DLX_IR_SIZE32_PC_SIZE32 -fullScreen
...
set init_oa_search_lib {}
set init_pwr_net vdd
set init_verilog /home/ms20.50/Desktop/DLX_project/project/synthesis/output_netlist/dlx_irsize32_pcsize32_topt_10.v
set init_lef_file /software/dk/nangate45/lef/NangateOpenCellLibrary.lef
set init_lef_file /software/dk/nangate45/lef/NangateOpenCellLibrary.lef
init_design
getIoFlowFlag
...
get_verify_drc_mode -use_min_spacing_on_block_obs -quiet
get_verify_drc_mode -limit -quiet
set_verify_drc_mode -disable_rules {} -check_implant true -check_implant_across_rows false -check_ndr_spacing false -check_same_via_cell false -exclude_pg_net false -ignore_trial_route false -report DLX_IR_SIZE32_PC_SIZE32_10.drc.rpt -limit 1000
verify_drc
setDrawView fplan
fit
...
dumpPictures -dir ./images_10/ -prefix DLX_IR_SIZE32_PC_SIZE32 -fullScreen
...
set init_oa_search_lib {}
set init_pwr_net vdd
set init_verilog /home/ms20.50/Desktop/DLX_project/project/synthesis/output_netlist/dlx_irsize32_pcsize32_topt_1_minarea.v
set init_lef_file /software/dk/nangate45/lef/NangateOpenCellLibrary.lef
set init_lef_file /software/dk/nangate45/lef/NangateOpenCellLibrary.lef
init_design
getIoFlowFlag
...
extractRC
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix DLX_IR_SIZE32_PC_SIZE32_1_minarea_postroute -outDir timingReports
get_time_unit
report_timing -machine_readable -max_paths 10000 -max_slack 0.75 -path_exceptions all > DLX_IR_SIZE32_PC_SIZE32_1_minarea.mtarpt
load_timing_debug_report -name default_report DLX_IR_SIZE32_PC_SIZE32_1_minarea.mtarpt
verifyConnectivity -type all -error 1000 -warning 50
setVerifyGeometryMode -area { 0 0 0 0 } -minWidth true -minSpacing true -minArea true -sameNet true -short true -overlap true -offRGrid false -offMGrid true -mergedMGridCheck true -minHole true -implantCheck true -minimumCut true -minStep true -viaEnclosure true -antenna false -insuffMetalOverlap true -pinInBlkg false -diffCellViol true -sameCellViol false -padFillerCellsOverlap true -routingBlkgPinOverlap true -routingCellBlkgOverlap true -regRoutingOnly false -stackedViasOnRegNet false -wireExt true -useNonDefaultSpacing false -maxWidth true -maxNonPrefLength -1 -error 1000
verifyGeometry
setVerifyGeometryMode -area { 0 0 0 0 }
...
dumpPictures -dir ./images_1_minarea/ -prefix DLX_IR_SIZE32_PC_SIZE32 -fullScreen
