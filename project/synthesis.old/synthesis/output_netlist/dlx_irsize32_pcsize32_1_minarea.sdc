...
# Created by write_sdc on Mon Aug 31 16:37:59 2020
...
create_clock -name clk  -period 19.9757  -waveform {0 9.98785}
set_max_delay 19.9757  -from [list [get_ports CLK] [get_ports RST] [get_ports IRAM_READY] [get_ports \
